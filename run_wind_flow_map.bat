@echo off
title China Weather Wind Flow Map - Full Screen
color 0A

echo =====================================================
echo  China Weather Wind Flow Map - Full Screen
echo =====================================================
echo.
...
REM Run the application with the specific URL
python src/wind_flow_live_wallpaper.py --verbose --test --url https://www.weather.com.cn/radar/
if %errorlevel% neq 0 (
    color 0C
    echo.
